<div class="bg-purple-100 p-4 rounded-lg shadow-md">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="text-center">
            <p class="text-4xl font-bold text-gray-800"><?php echo e($attendedStudents); ?></p>
...
<script>
    document.addEventListener('livewire:load', function () {
        var options = {
            series: [window.livewire.find('<?php echo e($_instance->id); ?>').attendancePercentage],
            chart: {
                type: 'radialBar',
                height: 180,
                offsetY: -20,
...
<?php /**PATH /home/1292223.cloudwaysapps.com/bwwzkatavt/public_html/resources/views/livewire/attendance-percentage.blade.php ENDPATH**/ ?>