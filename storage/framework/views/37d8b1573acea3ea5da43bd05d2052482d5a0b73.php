...
<div class="min-h-screen flex items-center justify-center border-4 border-blue-500">
    <div class="login-card max-w-md w-full mx-auto p-8 bg-white rounded-lg shadow-lg">
        <!-- Logo Section -->
        <div class="text-2xl font-bold text-center"><?php echo e(__('Malamulo College Worship Portal')); ?></div>
...
<?php /**PATH /home/1292223.cloudwaysapps.com/bwwzkatavt/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>