<?php if($paginator->hasPages()): ?>
    <nav role="navigation" aria-label="<?php echo e(__('Pagination Navigation')); ?>" class="flex justify-center items-center">
                            ...
                            <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $paginator->currentPage()): ?>
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-blue-600 bg-white border border-blue-500 leading-5"><?php echo e($page); ?></span>
                                    </span>
                                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\New_Attendance_App\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>