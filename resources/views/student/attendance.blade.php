...
<body style="padding-top: 4rem;">
    ...
    <div class="max-w-6xl mx-auto mt-5 bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="flex flex-wrap shadow-sm px-6 py-4">
            <a href="{{ route('student.create') }}" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                Register
            </a>
            <a href="#" onclick="openModal()" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                Import
            </a>
            <a href="{{ url('/generate-qrcodes') }}" aria-current="page" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                Generate QRCodes
            </a>
            <a href="{{ route('students.all-qrcodes') }}" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                View all QRCodes
            </a>
            <a href="{{ route('exportToExcel') }}" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                Grades with attendance
            </a>
            <a href="{{ route('attendance.upload.form') }}" class="px-4 py-2 mb-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
                Mark Grades Manually
            </a>
            <form action="{{ route('export') }}" method="GET" class="mb-2">
            ...
            <table class="table table-striped" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="{{ $student->avg_grade < 50 ? 'bg-red-200 text-red-800 py-1 px-2 rounded-full' : 'bg-green-200 text-green-800 py-1 px-2 rounded-full' }}">
                                {{ $student->avg_grade }}%
                            </span>
                        </td>
                        <td>
