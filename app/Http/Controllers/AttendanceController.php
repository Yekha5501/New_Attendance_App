...

{
    ...
    public function showAttendance(Request $request)
    {
        ...
        // Paginate and filter students based on the search query
        ...
        foreach ($students as $student) {
            ...
            // Calculate and update the attendance percentage
            $attendancePercentage = $totalSessions > 0 ? ($attendedSessions / $totalSessions) * 100 : 0;
            $student->avg_grade = round($attendancePercentage);
            $student->save();
        }

        // Return the view with the paginated and filtered students
